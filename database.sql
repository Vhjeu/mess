...
CREATE TABLE IF NOT EXISTS users (
  ...
  email_change_old_code_hash CHAR(64) DEFAULT NULL,
  email_change_old_expires_at DATETIME(6) DEFAULT NULL,
  email_change_old_sent_at DATETIME(6) DEFAULT NULL,
  email_change_old_window_started_at DATETIME(6) DEFAULT NULL,
  email_change_old_send_count INT UNSIGNED NOT NULL DEFAULT 0,
  email_change_old_attempts INT UNSIGNED NOT NULL DEFAULT 0,
  email_change_authorized_until DATETIME(6) DEFAULT NULL,
